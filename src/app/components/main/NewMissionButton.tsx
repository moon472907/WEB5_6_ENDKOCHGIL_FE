  ...
  return (
    <div className="fixed bottom-40 right-10 inset-x-0 flex justify-center">
      <div className="relative w-full max-w-[600px] px-4">
        <button
          type="button"
          className="absolute right-0 flex items-center justify-center w-14 h-14 rounded-full shadow-[0_8px_6px_0_rgba(0,0,0,0.25)] bg-button-point hover:bg-button-active transition-colors cursor-pointer"
